...
export function adaptRoomState(
  ...
  return Object.freeze({
    ...
    darknessStage: state.darknessStage,
    darknessElapsedTicks: state.darknessElapsedTicks,
    darknessNextStageTick: state.darknessNextStageTick,
    darknessHalfWidth: state.darknessHalfWidth,
    ...
    simulationP50Milliseconds: state.simulationP50Milliseconds ?? 0,
    simulationP95Milliseconds: state.simulationP95Milliseconds ?? 0,
    simulationP99Milliseconds: state.simulationP99Milliseconds ?? 0,
    serverEntityCount: state.serverEntityCount ?? 0,
    serverHeapMegabytes: state.serverHeapMegabytes ?? 0,
